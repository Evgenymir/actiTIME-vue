...
<script>
    import ArrowRight from '../image/icon/icon-arrow-right-color';
...
<style lang="scss">
    ...
    .slider-description-product {
        ...
        &__item-content {
            ...
            border-radius: 50px;
            box-shadow: 0 10px 0 $article-shadow;
            padding: 41px 30px;
            margin-left: auto;
            margin-right: auto;
        ...
        &__item-label {
            ...
            box-shadow: 0 4px 0 rgba($black, 0.07);
        ...
        .slick-dots {
            ...
            button {
                ...
                padding: 0;
                text-indent: -2000px;
                transition: width, height, background, ease 0.5s;
                cursor: pointer;
